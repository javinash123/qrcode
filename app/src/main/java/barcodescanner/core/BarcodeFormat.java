...
public class BarcodeFormat {
    ...
    public static final BarcodeFormat UPCE = new BarcodeFormat(Symbol.UPCE, "UPCEBarcode");
    public static final BarcodeFormat ISBN10 = new BarcodeFormat(Symbol.ISBN10, "ISBN10");
    public static final BarcodeFormat UPCA = new BarcodeFormat(Symbol.UPCA, "UPCABarcode");
    public static final BarcodeFormat EAN13 = new BarcodeFormat(Symbol.EAN13, "EAN13Barcode");
