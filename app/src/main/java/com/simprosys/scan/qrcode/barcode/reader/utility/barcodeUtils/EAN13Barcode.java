 ...
 * EAN-13 encoding
 */
public class EAN13Barcode extends BarcodeCommon implements IBarcode {
    ...
    private TreeMap<Integer, String> countryCodes = new TreeMap<>();

    public EAN13Barcode(String input) {
        setRawData(input);
        calculateCheckDigit();
    }
