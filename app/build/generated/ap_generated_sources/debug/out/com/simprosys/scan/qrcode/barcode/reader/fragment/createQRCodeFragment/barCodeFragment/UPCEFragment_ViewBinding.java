...
public class UPCEFragment_ViewBinding implements Unbinder {
  private UPCEFragment target;
  ...
  @UiThread
  public UPCEFragment_ViewBinding(final UPCEFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    UPCEFragment target = this.target;
