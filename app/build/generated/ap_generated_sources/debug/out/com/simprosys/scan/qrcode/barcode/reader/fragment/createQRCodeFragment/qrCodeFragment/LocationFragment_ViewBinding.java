...
public class LocationFragment_ViewBinding implements Unbinder {
  ...
  public LocationFragment_ViewBinding(final LocationFragment target, View source) {
    ...
    target.edtLatitude = Utils.findRequiredViewAsType(source, R.id.edtLatitude, "field 'edtLatitude'", EditText.class);
    target.edtLongitude = Utils.findRequiredViewAsType(source, R.id.edtLongitude, "field 'edtLongitude'", EditText.class);
  }
  ...
  public void unbind() {
    ...
    target.imgDone = null;
    target.edtLatitude = null;
    target.edtLongitude = null;
