...
public class Code39Fragment_ViewBinding implements Unbinder {
  private Code39Fragment target;
  ...
  @UiThread
  public Code39Fragment_ViewBinding(final Code39Fragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    Code39Fragment target = this.target;
