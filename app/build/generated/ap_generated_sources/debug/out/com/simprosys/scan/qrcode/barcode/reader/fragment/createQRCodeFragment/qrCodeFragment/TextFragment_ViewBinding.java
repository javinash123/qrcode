...
public class TextFragment_ViewBinding implements Unbinder {
  ...
  @UiThread
  public TextFragment_ViewBinding(final TextFragment target, View source) {
    this.target = target;
    ...
    target.edtMessage = Utils.findRequiredViewAsType(source, R.id.edtMessage, "field 'edtMessage'", EditText.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    TextFragment target = this.target;
