...
public class LinkedInFragment_ViewBinding implements Unbinder {
  private LinkedInFragment target;
  ...
  @UiThread
  public LinkedInFragment_ViewBinding(final LinkedInFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    LinkedInFragment target = this.target;
