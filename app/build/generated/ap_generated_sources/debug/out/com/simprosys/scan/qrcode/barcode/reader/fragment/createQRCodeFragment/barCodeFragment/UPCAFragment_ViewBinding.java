...
public class UPCAFragment_ViewBinding implements Unbinder {
  private UPCAFragment target;
  ...
  @UiThread
  public UPCAFragment_ViewBinding(final UPCAFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    UPCAFragment target = this.target;
