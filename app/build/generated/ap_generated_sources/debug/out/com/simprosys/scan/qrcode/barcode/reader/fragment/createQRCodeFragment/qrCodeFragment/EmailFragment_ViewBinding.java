...
public class EmailFragment_ViewBinding implements Unbinder {
  ...
  @UiThread
  public EmailFragment_ViewBinding(final EmailFragment target, View source) {
    this.target = target;
    ...
    target.edtSubject = Utils.findRequiredViewAsType(source, R.id.edtSubject, "field 'edtSubject'", EditText.class);
    target.edtBody = Utils.findRequiredViewAsType(source, R.id.edtBody, "field 'edtBody'", EditText.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    EmailFragment target = this.target;
