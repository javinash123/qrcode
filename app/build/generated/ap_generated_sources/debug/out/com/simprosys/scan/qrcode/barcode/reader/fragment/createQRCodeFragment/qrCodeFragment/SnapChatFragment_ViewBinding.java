...
public class SnapChatFragment_ViewBinding implements Unbinder {
  private SnapChatFragment target;
  ...
  @UiThread
  public SnapChatFragment_ViewBinding(final SnapChatFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SnapChatFragment target = this.target;
